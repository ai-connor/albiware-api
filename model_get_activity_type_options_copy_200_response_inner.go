...
// checks if the GetActivityTypeOptionsCopy200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetActivityTypeOptionsCopy200ResponseInner{}
...
type _GetActivityTypeOptionsCopy200ResponseInner GetActivityTypeOptionsCopy200ResponseInner

// NewGetActivityTypeOptionsCopy200ResponseInner instantiates a new GetActivityTypeOptionsCopy200ResponseInner object
...
func NewGetActivityTypeOptionsCopy200ResponseInner() *GetActivityTypeOptionsCopy200ResponseInner {
	this := GetActivityTypeOptionsCopy200ResponseInner{}
	var id int32 = 0
	this.Id = &id
	return &this
}

// NewGetActivityTypeOptionsCopy200ResponseInnerWithDefaults instantiates a new GetActivityTypeOptionsCopy200ResponseInner object
...
func (o *GetActivityTypeOptionsCopy200ResponseInner) UnmarshalJSON(data []byte) (err error) {
	varGetActivityTypeOptionsCopy200ResponseInner := _GetActivityTypeOptionsCopy200ResponseInner{}

	err = json.Unmarshal(data, &varGetActivityTypeOptionsCopy200ResponseInner)

	if err != nil {
		return err
	}

	*o = GetActivityTypeOptionsCopy200ResponseInner(varGetActivityTypeOptionsCopy200ResponseInner)
...
type NullableGetActivityTypeOptionsCopy200ResponseInner struct {
	value *GetActivityTypeOptionsCopy200ResponseInner
	isSet bool
}
...
func NewNullableGetActivityTypeOptionsCopy200ResponseInner(val *GetActivityTypeOptionsCopy200ResponseInner) *NullableGetActivityTypeOptionsCopy200ResponseInner {
	return &NullableGetActivityTypeOptionsCopy200ResponseInner{value: val, isSet: true}
}
