...
// checks if the DateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DateData{}
...
type _DateData DateData

// NewDateData instantiates a new DateData object
...
// NewDateDataWithDefaults instantiates a new DateData object
...
func (o *DateData) UnmarshalJSON(data []byte) (err error) {
	varDateData := _DateData{}

	err = json.Unmarshal(data, &varDateData)

	if err != nil {
		return err
	}

	*o = DateData(varDateData)
...
func NewNullableDateData(val *DateData) *NullableDateData {
	return &NullableDateData{value: val, isSet: true}
}
